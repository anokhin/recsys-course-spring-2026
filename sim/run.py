...
def run_experiment(
    ...
    elif recommender == SIMPLE_RANKER:
        from sim.agents.simple_ranker import SimpleRanker
        recommender = SimpleRanker(env.action_space)
    elif recommender == SASREC_I2I:
        from sim.agents.sasrec_adapter import SasrecAdapter
        recommender = SasrecAdapter(env.action_space)
    else:
...
def main():
    ...
    single_parser.add_argument(
        "--recommender", 
        choices=[DUMMY, REMOTE, CONSOLE, SIMPLE_RANKER, SASREC_I2I],
