...
recommendations_two_tower_redis = Redis(app, config_prefix="REDIS_RECOMMENDATIONS_TWO_TOWER")
...
catalog.upload_recommendations(
    recommendations_two_tower_redis.connection,
    "RECOMMENDATIONS_TWO_TOWER_FILE_PATH",
    key_object="item_id",
    key_recommendations="recommendations",
)
...
two_tower_recommender = I2IRecommender(
    listen_history_redis.connection,
    recommendations_two_tower_redis.connection,
    random_recommender,
)
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        treatment = Experiments.TWO_TOWER.assign(user)

        if treatment == Treatment.C:
            recommender = sasrec_i2i_recommender
        elif treatment == Treatment.T1:
            recommender = two_tower_recommender
        else:
