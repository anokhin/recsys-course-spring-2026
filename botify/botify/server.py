...
recommendations_user_top_redis = Redis(app, config_prefix="REDIS_RECOMMENDATIONS_USER_TOP")
...
catalog.upload_recommendations(
    recommendations_user_top_redis.connection,
    "RECOMMENDATIONS_USER_TOP_FILE_PATH"
)
...
user_top_recommender = UserTop(
    ...
    app.config["SESSION_VALUE_MODEL_FILE_PATH"],
)
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.C:
            ...
            recommender = user_top_recommender
        else:
