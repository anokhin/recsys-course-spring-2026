...
from botify.recommenders.learned_i2i import LearnedI2IRecommender
...
recommendations_learned_i2i_redis = Redis(
    app, config_prefix="REDIS_RECOMMENDATIONS_LEARNED_I2I"
)
...
learned_i2i_recommender = LearnedI2IRecommender(
    listen_history_redis.connection,
    recommendations_learned_i2i_redis.connection,
    random_recommender,
)
...
catalog.upload_recommendations(
    recommendations_learned_i2i_redis.connection,
    "RECOMMENDATIONS_LEARNED_I2I_FILE_PATH",
    key_object="item_id",
    key_recommendations="recommendations",
)
